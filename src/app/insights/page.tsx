    ...
    return (
        ...
        <div>
            ...
            {/* <div className='flex flex-col md:flex-row justify-evenly mt-4'>
                <div>
                         <h2 className='text-lg md:text-xl font-bold p-5'>All Insights</h2>
                </div>
                ...
                <div>
                    ...
                    <div>
                        ...
                        <div className='border-1 w-28 ml-1 mt-1 md:w-[200px]'></div>
                    </div>

                    <select name="" id="" className='p-2 md:w-[200px] w-full'>

                        <option value="ai">Select Industry</option>

                    </select>

                    <div className='w-[300px] h-[200px] shadow-2xl bg-white overflow-y-scroll  p-3 gap-6'>
                        {
                            industries.map((item, index) => (
                                <div key={index} className='flex flex-row gap-6'>
                                    <input type="checkbox" className='cursor-pointer select-all' ref={checkBoxRef} onClick={handleSelectAll} />
                ...
                <div>
                    ...
                    <select name="" id="" className='p-2 md:w-[200px] w-full'>
                        <option value="ai">Select Service</option>
                    </select>
                ...
                <div>
                    ...
                    <select name="" id="" className='p-2 md:w-[200px] w-full mt-4'>
