...
const BottomEnginnering = () => {
    return (
        <div className='bg-white mt-24 p-8 xl:p-12 relative'>
            ...
            <div className='flex flex-row p-4 md:px-12 items-center justify-center'>
                <h1 className='max-w-[350px] text-2xl
            font-bold md:text-3xl lg:text-4xl '>How We Engineer Digital Outcomes</h1>
